...
extension TextStyleHelpers on TextStyle {
  ...
  TextStyle get appColor => copyWith(color: Colors.deepOrange.shade700);
  ...
  TextStyle get disableColor => copyWith(color: const Color(0xFFEEEEEE));
  TextStyle get selectedColorItems => copyWith(color: selectedColorItem);
  TextStyle get unSelectedColorItems => copyWith(color: unSelectedColorItem);
  TextStyle get ceon =>

...
//colors
const appcolorFF7612 = Color(0xFFFF7612);
const appcolororenge = Color(0xFFFEBC54);
...
const disableColor = Color(0xFFEEEEEE);
const appColor = Color(0xFFE64A19);
const black = Color(0xFF000000);
const selectedColorItem = Color.fromARGB(255, 34, 78, 117);
const unSelectedColorItem = Colors.grey;
final backGroundColor = Colors.grey[300];
final backGroundIconColor = Colors.grey[100];
...
const defaultPadding3 = EdgeInsets.all(3);
...
const horizontalDivider = Divider(height: 1.5, color: Colors.grey);
const horizontalDivider1 = Divider(height: 1, color: Colors.grey);
